...
#define TAG "DSolution_DS01_NV3030B"
...
class DSolution_DS01_NV3030B : public WifiBoard {
private:
    Button boot_button_;
    ...
    void InitializePowerManager() {
        power_manager_ = new PowerManager(CHARGE_DETECT_PIN);
    ...
    void InitializeDisplay() {
        ...
        ESP_LOGD(TAG, "Install NV3030B LCD driver");
...
DECLARE_BOARD(DSolution_DS01_NV3030B);
